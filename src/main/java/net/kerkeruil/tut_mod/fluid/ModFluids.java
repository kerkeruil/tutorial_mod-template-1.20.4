...
public class ModFluids {
    ...
    public static final FlowableFluid STILL_SLUDGE = Registry.register(Registries.FLUID,
            new Identifier(TutorialMod.mod_ID, "sludge"), new SludgeFluid.Still());
    public static final FlowableFluid FLOWING_SLUDGE = Registry.register(Registries.FLUID,
            new Identifier(TutorialMod.mod_ID, "flowing_sludge"), new SludgeFluid.Flowing());
    ...
    public static final Block SLUDGE_BLOCK = Registry.register(Registries.BLOCK, new Identifier(TutorialMod.mod_ID,
            "sludge_block"), new FluidBlock(ModFluids.STILL_SLUDGE, FabricBlockSettings.copyOf(Blocks.WATER)
            .replaceable().liquid()));
    public static final Item SLUDGE_BUCKET = Registry.register(Registries.ITEM, new Identifier(TutorialMod.mod_ID,
            "sludge_bucket"), new BucketItem(ModFluids.STILL_SLUDGE,
            new FabricItemSettings().recipeRemainder(Items.BUCKET).maxCount(1)));
