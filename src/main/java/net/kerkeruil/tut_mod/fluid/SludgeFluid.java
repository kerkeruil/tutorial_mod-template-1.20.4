...
public abstract class SludgeFluid extends FlowableFluid {
    ...
    public void randomDisplayTick(World world, BlockPos pos, FluidState state, Random random) {
        ...
        if (world.getBlockState(blockPos).isAir() && !world.getBlockState(blockPos).isOpaqueFullCube(world, blockPos)) {
            if (random.nextInt(100) == 0) {
                ...
                world.addParticle(ModParticles.NUCLEAR_SIGN_PARTICLE, d, e, f, 0.0, 0.0, 0.0);
    ...
    public Item getBucketItem() {
        return ModFluids.SLUDGE_BUCKET;
    }
    ...
    protected BlockState toBlockState(FluidState state) {
        return ModFluids.SLUDGE_BLOCK.getDefaultState().with(Properties.LEVEL_15, getBlockStateLevel(state));
    }
